...
namespace Downloader.Tests.Helper;

public static class AssertHelper
{
    static string s_chars = "abcdefghijklmnopqrstuvwxyz0123456789";
    static Random s_rand = new(DateTime.Now.GetHashCode());
    ...
    public static string GetRandomName(int length)
    {
        ...
        {
            sb.Append(s_chars[s_rand.Next(0, s_chars.Length)]);
        }
